...
//     }); 
var price = 0; // hide cart content when there's no product in it

$(".button").hide();
$(".item").hide();
$(".remove").hide(); // function to add product to the cart and display it there
...
$('.buy').click(function () {
  ...
  $("ul.dropdown-menu").prepend("<li data=\"".concat(this.id, "\" class=\"ml-2 item\">  \n            <a href=\"#\">\n            <span class=\"product\">").concat(name, "</span><span id=\"").concat(itemPrice, "\" class=\"selectedPrice\">\u20B9 ").concat(itemPrice, "</span> <img class=\"selectedImage\" src=\"").concat($(this).parent().siblings()[0].children[0].src, "\">\n            </a>\n            <div class=\"number\">\n              <span class=\"minus\">-</span>\n              <input type=\"text\" value=\"1\" name=\"numberOfProducts\" class=\"input\">\n              <span class=\"plus\">+</span>\n            </div>         \n         </li>"));
  $("#total").text("Total cost: ₹"); // displays "total cost" in the cart
